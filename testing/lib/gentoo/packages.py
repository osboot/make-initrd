...
def get_packages() -> PackageSet:
    return PackageSet(
        make_initrd=(
            ...
            "app-arch/zstd", "dev-libs/json-c", "sys-fs/squashfs-tools",
            "sys-fs/erofs-utils",
        ),
        make_initrd_devel=(
            "app-alternatives/cpio", "app-arch/tar", "dev-build/make",
            ...
            "app-arch/bzip2", "app-arch/xz-utils", "app-text/scdoc", "sys-libs/zlib",
            "app-arch/zstd", "dev-libs/json-c", "sys-fs/squashfs-tools",
            "sys-fs/erofs-utils", "dev-build/autoconf", "dev-build/automake",
            "dev-util/intltool", "sys-devel/bison", "sys-devel/flex",
            "virtual/pkgconfig",
        ),
        ...
        sysimage_extra=(
            ...
            "sys-fs/dosfstools", "sys-boot/grub", "dev-perl/File-ShareDir-Install",
        ),
        kickstart_extra=(
