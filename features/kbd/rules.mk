KBD_GENERATE_CONFIG_ONCE := $(shell $(shell_export_vars) $(FEATURESDIR)/kbd/bin/get-config)
...
KBD_DIRS    := $(shell $(shell_export_vars) $(FEATURESDIR)/kbd/bin/get-data dirs)
KBD_FILES   := $(shell $(shell_export_vars) $(FEATURESDIR)/kbd/bin/get-data files)
