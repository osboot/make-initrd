KBD_GENERATE_CONFIG_ONCE := $(shell $(call shell-export-vars) $(FEATURESDIR)/kbd/bin/get-config)
...
KBD_DIRS    := $(shell $(call shell-export-vars) $(FEATURESDIR)/kbd/bin/get-data dirs)
KBD_FILES   := $(shell $(call shell-export-vars) $(FEATURESDIR)/kbd/bin/get-data files)
