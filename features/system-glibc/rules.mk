...
SYSTEM_GLIBC_LIBNSS_FILES := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_LIBNSS_BIN) files)
SYSTEM_GLIBC_LIBNSS_DIRS  := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_LIBNSS_BIN) dirs)
...
SYSTEM_GLIBC_LIBGCC_S_FILES := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_LIBGCC_S_BIN) files)
SYSTEM_GLIBC_LIBGCC_S_DIRS  := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_LIBGCC_S_BIN) dirs)
...
SYSTEM_GLIBC_PWGR_FILES := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_PWGR_BIN) files)
SYSTEM_GLIBC_PWGR_DIRS  := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_PWGR_BIN) dirs)
...
SYSTEM_GLIBC_NETWORK_FILES := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_NETWORK_BIN) files)
SYSTEM_GLIBC_NETWORK_DIRS  := $(shell $(shell_export_vars) $(SYSTEM_GLIBC_NETWORK_BIN) dirs)
